...
const Footer = () => {
  return (
    <div className="px-4 pt-8 mt-auto  w-full  md:px-24 lg:px-8 bg-[#3175ac]  text-slate-300">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2 -mt-7">
          <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
            <Image src={logo} alt="Company Logo" className='w-44 pt-4' />
            <span className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-7xl">Who are We?</span>
          </a>
        ...
        <div className="space-y-2 text-sm items-center">
          <p className="text-base font-bold tracking-wide  text-slate-300 items-start">Contacts</p>
          <div className="flex">
        ...
        <div className='flex flex-col items-start pt-2'>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a href="/" className=" text-slate-300 transition-colors duration-300 hover:text-deep-purple-accent-400">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row text">
          <li>
